...
const ForgotPassword = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Forgot Password | AI Resume Pro</title>
        <meta name="description" content="Reset your password for AI Resume Pro. Enter your email to receive a secure password reset link and regain access to your account." />
        <meta name="robots" content="noindex, follow" />
        <meta property="og:title" content="Forgot Password | AI Resume Pro" />
        <meta property="og:description" content="Reset your password for AI Resume Pro. Enter your email to receive a secure password reset link and regain access to your account." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ai-resume-pro.com/forgot-password" />
        <meta property="og:image" content="https://ai-resume-pro.com/og-image.png" />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:title" content="Forgot Password | AI Resume Pro" />
        <meta property="twitter:description" content="Reset your password for AI Resume Pro. Enter your email to receive a secure password reset link and regain access to your account." />
