...
const SignUp = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Sign Up | AI Resume Pro</title>
        <meta name="description" content="Create a free account on AI Resume Pro to build professional, ATS-friendly resumes and cover letters with AI. Fast, secure registration for job seekers." />
        <meta name="robots" content="noindex, follow" />
        <meta property="og:title" content="Sign Up | AI Resume Pro" />
        <meta property="og:description" content="Create a free account on AI Resume Pro to build professional, ATS-friendly resumes and cover letters with AI." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://ai-resume-pro.com/signup" />
        <meta property="og:image" content="https://ai-resume-pro.com/og-image.png" />
        <meta property="twitter:card" content="summary_large_image" />
        <meta property="twitter:title" content="Sign Up | AI Resume Pro" />
        <meta property="twitter:description" content="Create a free account on AI Resume Pro to build professional, ATS-friendly resumes and cover letters with AI." />
